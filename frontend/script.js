...
// ==============================
const questions = [
       "هل يوجد تورم في الاطراف او في اماكن متفرقة من الجسم؟",
    "هل يوجد التهابات في الجلد او احمار مصاحب للتورم؟",
    "هل التورم يسبب الم ام حكة جلدية؟",
    "هل زاد التورم خلال دقائق ام احتاج ععد من الساعات؟",
    "هل يوجد احساس بلاختناق او صعوبة التنفس اثناء نوبات التورم؟",
    "هل يوجد انتفاخ بالبطن أو ألم شديد في البطن مصاحب للتورم؟",
    "هل تزداد نوبات التورم مع التعرض للتوتر او بالتزامن مع اوقات الدورية الشهرية؟",
    "هل يوجد تاريخ عائلي لأعراض مشابهة؟",
    "هل تم تشخيص أحد أفراد العائلة بمرض الوذمة الوعائية الوراثية؟",
    "هل توجد حالات وفيات في العائلة بسبب تورم جلدي واختناق حنجري؟"
